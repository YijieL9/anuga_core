...
domain.set_name('Testing_inlet_operator')                 # Output name
...
Q = file_function('/home/lixinhou/anuga_core/anuga/parallel/data/test_hydrograph.tms', quantities=['hydrograph'])
...
for t in domain.evolve(yieldstep = 1.0, finaltime = 38):
    ...
    print("depths of inlet's polygon:",inlet1.stage_c[:].take([inlet1.region.indices])-inlet1.elev_c[:].take([inlet1.region.indices]))
